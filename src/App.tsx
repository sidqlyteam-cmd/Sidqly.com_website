...
const siteRoutes = [
  ...
  <Route key="islamic-daily-dashboard" path="islamic-daily-dashboard" element={<IslamicDashboardPage />} />,
  ...
  <Route key="tasbih-counter" path="tasbih-counter" element={<DuasAzkarPage />} />,
  <Route key="salah-tracker" path="salah-tracker" element={<SalahTrackerPage />} />,
  <Route key="hijri-gregorian-converter" path="hijri-gregorian-converter" element={<IslamicCalendarPage />} />,
  <Route key="fasting-planner" path="fasting-planner" element={<RamadanPlannerPage />} />,
  <Route key="sadaqah-giving-planner" path="sadaqah-giving-planner" element={<SadqaZakatPlannerPage />} />,
