  ...
  return (
    <div className={`bg-white/5 rounded-2xl p-6 border border-white/10 md:col-span-2 ${className || ''}`}>
        ...
        <ul className="grid sm:grid-cols-2 gap-3">
          {links.map((link, i) => (
             <li key={i}>
               <Link to={link.url} className="text-white hover:text-sidqly-green-soft flex items-center gap-2 group text-sm font-medium">
...
export default RelatedSidqlyModules;
