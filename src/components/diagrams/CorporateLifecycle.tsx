...
const CorporateLifecycle: React.FC = () => {
  const steps = [
    { label: "Start point", text: "Corporate CSR/Zakat sponsor targets identified" },
    { label: "Review/action steps", text: "Sponsored campaigns run; Contribution summarized" },
    { label: "Human approval gates", text: "Impact data reviewed to ensure no private recipient exposure" },
    { label: "Output/result", text: "Downloadable PDF impact summary generated" },
    { label: "Safe visibility boundary", text: "Corporate-safe reporting delivered to sponsor board" }
  ];

  return (
    <div className="w-full max-w-4xl mx-auto py-8">
      <h3 className="text-xl font-bold text-sidqly-navy mb-6 text-center">Corporate CSR/Zakat Reporting</h3>
