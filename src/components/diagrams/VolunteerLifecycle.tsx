...
const VolunteerLifecycle: React.FC = () => {
  const steps = [
    { label: "Start point", text: "Volunteer assigned shifts/task list" },
    { label: "Review/action steps", text: "Delivery notes read; Proof instructions followed; Completion status updated" },
    { label: "Human approval gates", text: "Volunteer uploads proof & reports issues; Manager reviews" },
    { label: "Output/result", text: "Structured volunteer deployment logged" },
    { label: "Safe visibility boundary", text: "Volunteer efforts aggregated into impact reports securely" }
  ];

  return (
    <div className="w-full max-w-4xl mx-auto py-8">
      <h3 className="text-xl font-bold text-sidqly-navy mb-6 text-center">Volunteer Coordination</h3>
