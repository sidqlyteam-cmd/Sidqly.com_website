...
const ZakatLifecycle: React.FC = () => {
  const steps = [
    { label: "Start point", text: "Zakat intake form submitted or fund received" },
    { label: "Review/action steps", text: "Fund type tagging; Eligibility review status marked; Reviewer notes added" },
    { label: "Human approval gates", text: "Authorized scholar/policy team reviews & approves" },
    { label: "Output/result", text: "Audit-ready Zakat separation logs; Disbursement tracked" },
    { label: "Safe visibility boundary", text: "Anonymized Zakat impact reported to board/donors" }
  ];

  return (
    <div className="w-full max-w-4xl mx-auto py-8">
      <h3 className="text-xl font-bold text-sidqly-navy mb-6 text-center">Zakat Workflow</h3>
