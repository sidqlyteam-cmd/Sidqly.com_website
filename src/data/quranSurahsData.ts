...
export const SURAHS_LIST: SurahMeta[] = [
  ...
  { number: 4, name: "سُورَةُ ٱلنِّسَاءِ", englishName: "An-Nisa", englishNameTranslation: "The Women", numberOfAyahs: 176, revelationType: "Medinan" },
  ...
  { number: 9, name: "سُورَةُ ٱلتَّوْبَةِ", englishName: "At-Tawbah", englishNameTranslation: "The Repentance", numberOfAyahs: 129, revelationType: "Medinan" },
  ...
  { number: 20, name: "سُورَةُ طٰهٰ", englishName: "Taha", englishNameTranslation: "Ta-Ha", numberOfAyahs: 135, revelationType: "Meccan" },
  ...
  { number: 26, name: "سُورَةُ ٱلشُّعَرَاءِ", englishName: "Ash-Shu'ara", englishNameTranslation: "The Poets", numberOfAyahs: 227, revelationType: "Meccan" },
  ...
  { number: 32, name: "سُورَةُ ٱلسَّجْدَةِ", englishName: "As-Sajdah", englishNameTranslation: "The Prostration", numberOfAyahs: 30, revelationType: "Meccan" },
  ...
  { number: 37, name: "سُورَةُ ٱلصَّافَّاتِ", englishName: "As-Saffat", englishNameTranslation: "Those who set the Ranks", numberOfAyahs: 182, revelationType: "Meccan" },
  { number: 38, name: "سُورَةُ صٓ", englishName: "Sad", englishNameTranslation: "The Letter Sad", numberOfAyahs: 88, revelationType: "Meccan" },
  { number: 39, name: "سُورَةُ ٱلزُّمَرِ", englishName: "Az-Zumar", englishNameTranslation: "The Troops", numberOfAyahs: 75, revelationType: "Meccan" },
  ...
  { number: 42, name: "سُورَةُ ٱلشُّورَىٰ", englishName: "Ash-Shuraa", englishNameTranslation: "The Consultation", numberOfAyahs: 53, revelationType: "Meccan" },
  { number: 43, name: "سُورَةُ ٱلزُّخْرُفِ", englishName: "Az-Zukhruf", englishNameTranslation: "The Ornaments of Gold", numberOfAyahs: 89, revelationType: "Meccan" },
  ...
  { number: 55, name: "سُورَةُ ٱلرَّحْمَٰنِ", englishName: "Ar-Rahman", englishNameTranslation: "The Beneficent", numberOfAyahs: 78, revelationType: "Medinan" },
  ...
  { number: 64, name: "سُورَةُ ٱلتَّغَابُنِ", englishName: "At-Taghabun", englishNameTranslation: "The Mutual Disillusion", numberOfAyahs: 18, revelationType: "Medinan" },
  { number: 65, name: "سُورَةُ ٱلطَّلَاقِ", englishName: "At-Talaq", englishNameTranslation: "The Divorce", numberOfAyahs: 12, revelationType: "Medinan" },
  ...
  { number: 69, name: "سُورَةُ ٱلْحَاقَّةِ", englishName: "Al-Haqqah", englishNameTranslation: "The Reality", numberOfAyahs: 52, revelationType: "Meccan" },
  ...
  { number: 76, name: "سُورَةُ ٱلْإِنْسَانِ", englishName: "Al-Insan", englishNameTranslation: "Man", numberOfAyahs: 31, revelationType: "Medinan" },
  ...
  { number: 79, name: "سُورَةُ ٱلنَّازِعَاتِ", englishName: "An-Nazi'at", englishNameTranslation: "Those who drag forth", numberOfAyahs: 46, revelationType: "Meccan" },
  ...
  { number: 84, name: "سُورَةُ ٱلْإِنْشِقَاقِ", englishName: "Al-Inshiqaq", englishNameTranslation: "The Sundering", numberOfAyahs: 25, revelationType: "Meccan" },
  ...
  { number: 86, name: "سُورَةُ ٱلطَّارِقِ", englishName: "At-Tariq", englishNameTranslation: "The Morning Star", numberOfAyahs: 17, revelationType: "Meccan" },
  ...
  { number: 92, name: "سُورَةُ ٱلَّلَيْلِ", englishName: "Al-Layl", englishNameTranslation: "The Night", numberOfAyahs: 21, revelationType: "Meccan" },
  { number: 93, name: "سُورَةُ ٱلضُّحَىٰ", englishName: "Ad-Duhaa", englishNameTranslation: "The Morning Hours", numberOfAyahs: 11, revelationType: "Meccan" },
  { number: 94, name: "سُورَةُ ٱلشَّرْحِ", englishName: "Ash-Sharh", englishNameTranslation: "The Relief", numberOfAyahs: 8, revelationType: "Meccan" },
  ...
  { number: 98, name: "سُورَةُ ٱلْبَيِّنَةِ", englishName: "Al-Bayyinah", englishNameTranslation: "The Clear Proof", numberOfAyahs: 8, revelationType: "Medinan" },
  { number: 99, name: "سُورَةُ ٱلزَّلْزَلَةِ", englishName: "Az-Zalzalah", englishNameTranslation: "The Earthquake", numberOfAyahs: 8, revelationType: "Medinan" },
  { number: 100, name: "سُورَةُ ٱلْعَادِيَاتِ", englishName: "Al-'Adiyat", englishNameTranslation: "The Courser", numberOfAyahs: 11, revelationType: "Meccan" },
  { number: 101, name: "سُورَةُ ٱلْقَارِعَةِ", englishName: "Al-Qari'ah", englishNameTranslation: "The Calamity", numberOfAyahs: 11, revelationType: "Meccan" },
  ...
  { number: 103, name: "سُورَةُ ٱلْعَصْرِ", englishName: "Al-'Asr", englishNameTranslation: "The Declining Day", numberOfAyahs: 3, revelationType: "Meccan" },
  { number: 104, name: "سُورَةُ ٱلْهُمَزَةِ", englishName: "Al-Humazah", englishNameTranslation: "The Traducer", numberOfAyahs: 9, revelationType: "Meccan" },
  ...
  { number: 107, name: "سُورَةُ ٱلْمَاعُونِ", englishName: "Al-Ma'un", englishNameTranslation: "The Small Kindnesses", numberOfAyahs: 7, revelationType: "Meccan" },
  ...
  { number: 110, name: "سُورَةُ ٱلنَّصْرِ", englishName: "An-Nasr", englishNameTranslation: "The Divine Support", numberOfAyahs: 3, revelationType: "Medinan" },
