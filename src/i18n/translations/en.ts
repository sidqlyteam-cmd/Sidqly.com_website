...
const defaultNamazTranslator = {
  ...
  subtitle:
    'Explore authentic Salah recitations with Uthmani Arabic text, transliteration, multi-language translations, word-by-word breakdowns, and Sunnah variants.',
  ...
  noResultsDesc:
    'Try adjusting your search terms or clearing section filters.',
  clearFilters: 'Clear Filters',
  disclaimerTitle: 'Scholarly & Educational Disclaimer',
  disclaimerText:
    'This tool is provided for educational and operational planning purposes. All translations and Hadith references are sourced from human-verified classical collections. Where Sunnah variants exist, they are explicitly cited rather than presenting a single wording as mandatory.',
  sourcesNote:
    'Sources: Sahih al-Bukhari, Sahih Muslim, Sunan Abi Dawud, Jami` at-Tirmidhi, Sahih International, Fateh Muhammad Jalandhri, Muhammad Hamidullah, Bubenheim & Elyas.',
};
...
export const enTranslations: UITranslationKeys = {
  ...
  islamicTools: {
    ...
    zakat: {
      ...
      belowNisab:
        'Net zakatable wealth is below the Nisab threshold.',
    ...
    quranReader: {
      title: 'Quran Reader & Search',
      subtitle: 'Explore the Holy Qur\'an with 114 Surahs, clear Arabic text, translations, search, bookmarks, and last-read tracking.',
      searchPlaceholder: 'Search Surahs or Ayahs by keyword...',
      selectSurah: 'Select Surah',
      surahList: 'All Surahs (114)',
      ayahsCount: 'Ayahs',
      meccan: 'Meccan',
      medinan: 'Medinan',
      ...
      noBookmarks: 'No bookmarked Ayahs yet.',
      searchResults: 'Search Results',
      noSearchResults: 'No Ayahs found matching your query.',
      loadingSurah: 'Loading Surah text...',
      errorLoading: 'Unable to load Surah text. Please check your network connection.',
      backToSurahs: 'Back to Surahs List',
    },
    duasAzkar: {
      title: 'Duas & Daily Azkar',
      subtitle: 'Authentic Supplications and Daily Reminders categorized from Quran and Sunnah.',
      searchPlaceholder: 'Search Duas by keyword or category...',
      categoriesTab: 'Categories',
      favoritesTab: 'Favorites',
      dailyDuaTitle: 'Daily Featured Supplication',
      copyDua: 'Copy Supplication',
      shareDua: 'Share Supplication',
      copied: 'Copied to clipboard!',
      noFavorites: 'No favorite Duas saved yet.',
      noResults: 'No Duas found matching your search.',
      repeatCount: 'Recite times:',
      reference: 'Reference:',
      categories: {
        ...
        stress: 'Distress & Hardship',
        gratitude: 'Gratitude',
        general: 'General Duas',
      },
    },
    salahTracker: {
      title: 'Salah & Qaza Prayer Tracker',
      subtitle: 'Track daily prayer habits, completion metrics, and manage missed Qaza prayer logs safely.',
      todaySummary: 'Today\'s Overview',
      completedPrayers: 'Completed',
      missedPrayers: 'Missed',
      qazaPrayers: 'Qaza Offertory',
      completionRate: 'Completion Rate',
      markCompleted: 'Completed',
      markMissed: 'Missed',
      markQaza: 'Mark Qaza',
      clearStatus: 'Reset',
      qazaTrackerTitle: 'Qaza Prayer Counter Log',
      qazaTrackerSubtitle: 'Record and manage accumulated missed prayers to complete them progressively.',
      weeklyHistoryTitle: '7-Day History Summary',
      disclaimerTitle: 'Personal Tracking Disclaimer',
      disclaimerText: 'This tracking tool is provided as a personal habit and productivity tracker for your prayers. Personal data is stored strictly in your browser and never shared.',
      prayers: {
        fajr: 'Fajr',
        dhuhr: 'Dhuhr',
        asr: 'Asr',
